...
namespace Game.Core.PostProcessing.UnityEditor
{
    static partial class LocalVolumetricFogUI
    {
        internal static class Styles
        {
            ...
            public static readonly GUIContent s_AlbedoLabel = new GUIContent("单次散射颜色", "The color this fog scatters light to.");
            public static readonly GUIContent s_MeanFreePathLabel = new GUIContent("雾气衰减", "Density at the base of the fog. Determines how far you can see through the fog in meters.");
            ...
            public static readonly GUIContent s_PriorityLabel = new GUIContent("优先级", "Priority.");
            ...
            public static readonly GUIContent s_InvertFadeLabel = new GUIContent("反转雾气浓度", "Inverts blend values so 0 becomes the new maximum value and the original maximum value becomes 0.");
            public static readonly GUIContent s_FalloffMode = new GUIContent("体积雾计算方式", "When Blend Distance is above 0, controls which kind of falloff is applied to the transition area.");
            ...
            public static readonly GUIContent s_DistanceFadeStartLabel = new GUIContent("开始消散距离", "Sets the distance from the Camera where Local Volumetric Fog starts to fade out.");
            public static readonly GUIContent s_DistanceFadeEndLabel = new GUIContent("完全消散距离（越小性能越好）", "Sets the distance from the Camera where Local Volumetric Fog is completely faded out.");
