...
namespace Game.Core.PostProcessing.UnityEditor
{
    ...
    sealed class ExposureEditor : VolumeComponentEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            /*if (mode == (int)Exposure.ExposureMode.UsePhysicalCamera)
            {
                PropertyField(m_Compensation);
            }
            else */if (mode == (int)Exposure.ExposureMode.Fixed)
            {
            ...
            else
            {
                ...
                if (m_MeteringMode.value.intValue == (int)Exposure.MeteringMode.MaskWeighted)
                    PropertyField(m_WeightTextureMask);

                if (m_MeteringMode.value.intValue == (int)Exposure.MeteringMode.ProceduralMask)
                {
                ...
                /*if (mode == (int)Exposure.ExposureMode.CurveMapping)
                {
                ...
                else */if (!(mode == (int)Exposure.ExposureMode.AutomaticHistogram && m_HistogramCurveRemapping.value.boolValue))
                {
                ...
                if (mode == (int)Exposure.ExposureMode.AutomaticHistogram)
                {
                ...
                if (m_AdaptationMode.value.intValue == (int)Exposure.AdaptationMode.Progressive)
                {
            ...
            if (/*mode == (int)Exposure.ExposureMode.Automatic ||*/ mode == (int)Exposure.ExposureMode.AutomaticHistogram)
            {
