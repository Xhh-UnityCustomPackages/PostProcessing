...
// Generated from Game.Core.PostProcessing.FrustumGPU
// PackingRules = Exact
struct FrustumGPU
{
    float3 normal0;
...
// Generated from Game.Core.PostProcessing.OrientedBBox
// PackingRules = Exact
struct OrientedBBox
{
    float3 right;
...
//
// Accessors for Game.Core.PostProcessing.OrientedBBox
//
