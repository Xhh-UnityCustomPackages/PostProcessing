...
//
//         public List<LocalVolumetricFog> PrepareLocalVolumetricFogData(VolumetricCameraParams currentCam)
//         {
//             //Update volumes
...
//                 RegisterFogUpdateBeforeScriptUpdate(typeof(RegisterLocalVolumetricFogEarlyUpdate), UpdateRefreshLocalFogIndex, ref currentLoopSystem);
...
//             }
//
//             internal static void UpdateRefreshLocalFogIndex()
//             {
//                 if (!LocalVolumetricFogManager.manager?.IsInitialized() ?? true)
//                     return;
//
