...
//
//             m_RenderingProperties.SetInteger(VolumetricFogShaderIDs._VolumetricFogGlobalIndex, m_GlobalIndex);
//
...
//                 {
//                     var runtimeShaders = GraphicsSettings.GetRenderPipelineSettings<VolumetricFogRuntimeShaders>();
...
//                 {
//
//                     m_RenderingProperties.SetTexture(VolumetricFogShaderIDs._VolumetricMask, parameters.volumeMask);
...
//                 }
//
//                 m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricScrollSpeed, parameters.textureScrollingSpeed);
//                 m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricTiling, parameters.textureTiling);
//                 m_RenderingProperties.SetFloat(VolumetricFogShaderIDs._AlphaOnlyTexture, alphaTexture ? 1 : 0);
//
...
//                 return;
//
//             m_RenderingProperties.SetBuffer(VolumetricFogShaderIDs._VolumetricMaterialData, LocalVolumetricFogManager.manager.volumetricMaterialDataBuffer);
//
...
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialObbRight, bounds.right);
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialObbUp, bounds.up);
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialObbExtents, new Vector3(bounds.extentX, bounds.extentY, bounds.extentZ));
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialObbCenter, bounds.center);
//
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialRcpPosFaceFade, engineData.rcpPosFaceFade);
//             m_RenderingProperties.SetVector(VolumetricFogShaderIDs._VolumetricMaterialRcpNegFaceFade, engineData.rcpNegFaceFade);
//             m_RenderingProperties.SetInteger(VolumetricFogShaderIDs._VolumetricMaterialInvertFade, engineData.invertFade);
//
//             m_RenderingProperties.SetFloat(VolumetricFogShaderIDs._VolumetricMaterialRcpDistFadeLen, engineData.rcpDistFadeLen);
//             m_RenderingProperties.SetFloat(VolumetricFogShaderIDs._VolumetricMaterialEndTimesRcpDistFadeLen, engineData.endTimesRcpDistFadeLen);
//             m_RenderingProperties.SetInteger(VolumetricFogShaderIDs._VolumetricMaterialFalloffMode, (int)engineData.falloffMode);
//
