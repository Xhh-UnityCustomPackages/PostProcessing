Shader "Hidden/VolumetricFog"
{
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Packages/com.unity.render-pipelines.core/Runtime/Utilities/Blit.hlsl"
            #include "Packages/com.game.rendering.postprocessing/ShaderLibrary/DepthAwareGaussianBlur.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Packages/com.unity.render-pipelines.core/Runtime/Utilities/Blit.hlsl"
            #include "Packages/com.game.rendering.postprocessing/ShaderLibrary/DepthAwareUpsample.hlsl"
